...
//
	public class JsonThreadMapper
	{
		static private JsonThreadMapper mInstance;
		static public JsonThreadMapper Instance
		{
			get
			{
				if(mInstance == null)
				{
					mInstance = new JsonThreadMapper();
				}
				return mInstance;
			}
		}
	...
	public static class JsonThreadMapperExtend
	{
//		static public string ToJson (object obj)
//		{
//			return JsonThreadMapper.Instance.ToJson(obj);
//		}
//		
//		static public  void ToJson (object obj, JsonWriter writer)
//		{
//			JsonThreadMapper.Instance.ToJson (obj, writer);
//		}
//		
//		static public  JsonData ToObject (JsonReader reader)
//		{
//			return JsonThreadMapper.Instance.ToObject(reader);
//		}
//
...
//		{
//			return JsonThreadMapper.Instance.ToObject (json);
//		}
//		
//		static public  T ToObject<T> (JsonReader reader)
//		{
//			return JsonThreadMapper.Instance.ToObject<T> (reader);
//		}
//		
...
//		}
		...
		static public  object ToObject(this JsonThreadMapper jm,System.Type type, string json)
		{
			return JsonThreadMapper.Instance.ReadValue(type, new JsonReader( json ));
		}
