...
public class ExecUtil
{
	...
	/// 
	public static int Run(string exec, string argument, out string output, bool ignoreError = false, bool hasOutput = true, string workingDir = null)
	{
		string s = "";
	...
	public static int Run(string exec, string argument, bool ignoreError = false, string workingDir = null)
	{
		string ret = null;
		return Run(exec, argument, out ret, ignoreError, false, workingDir);
	}
