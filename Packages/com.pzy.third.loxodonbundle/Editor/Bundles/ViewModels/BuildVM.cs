...
namespace Loxodon.Framework.Bundles.Editors
{
    ...
    public class BuildVM : AbstractViewModel
    {
        ...
        public const string PATH = "AppData/Loxodon/BuildSetting.json";
        ...
        public virtual void Build(bool forceRebuild)
        {
            ...
            //// 在这里调用刷新 bundle 工具
            //// 有机会可以改成反射调用
            //RefreshBundleTool.RefreshBundle();


            // pzy:
            // 调用插件
            BundleBuilderPluginManager.NotifyPreBuild();
            ...
            // pzy:
            // 调用插件
            BundleBuilderPluginManager.NotifyPostBuild();
        }
