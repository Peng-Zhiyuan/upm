...
namespace Loxodon.Framework.Bundles
{
    public interface IBundle : System.IDisposable
    {
        ...
        /// <param name="names"></param>
        /// <returns></returns>
        IProgressResult<float, Dictionary<string,T>> LoadAssetsToMapAsync<T>(params string[] names) where T : Object;
        ...
        /// <param name="names"></param>
        /// <returns></returns>
        IProgressResult<float, Dictionary<string, Object>> LoadAssetsToMapAsync(System.Type type, params string[] names);
