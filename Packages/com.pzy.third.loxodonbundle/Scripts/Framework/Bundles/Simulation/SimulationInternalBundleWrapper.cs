...
namespace Loxodon.Framework.Bundles
{
    ...
    /// Bundle wrapper
    /// </summary>
    internal class SimulationInternalBundleWrapper : IBundle
    {
        private SimulationBundle bundle;
        public SimulationInternalBundleWrapper(SimulationBundle bundle)
        {
            this.bundle = bundle;
            this.bundle.Retain();
        }
        ...
        public virtual string[] GetBundleAssetNames(){
            return bundle.GetBundleAssetNames();
        }
        ...
        ~SimulationInternalBundleWrapper()
        {
            Dispose(false);
        }
