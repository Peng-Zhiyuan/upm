...
namespace Pegasus
{
    ...
    public class PegasusPoiEditor : Editor
    {
        ...
        private static Dictionary<string, string> m_tooltips = new Dictionary<string, string>
        {
            ...
            { "Auto Roll", "Auto Roll will automatically roll or bank the POI on turns. If enabled then this POI's ROLL (Z) is automatically calculated based on its speed through the turn and on the Roll settings under Advanced in Pegasus Manager." },
        };
    }
}
