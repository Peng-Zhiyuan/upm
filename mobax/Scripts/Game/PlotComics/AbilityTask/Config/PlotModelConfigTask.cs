...
{
    public class PlotModelConfigTaskData : PlotConfigAbilityTaskData
    {
        ...
        {
            base.Init(element);
            PlotComicsSceneModelElement configElement = (PlotComicsSceneModelElement)element;
    ...
    public class PlotModelConfigTask : PlotConfigAbilityTask
    {
        public PlotModelConfigTaskData TaskData => (PlotModelConfigTaskData)this.TaskInitData;
