...
{
    [PlotComicsConfigElementItem("场景模型", (int)EPlotComicsElementType.SceneModel, (int) EConfigPriority.SceneModel)]
    public class PlotComicsSceneModelElement : PlotComicsConfigElementItem
    {
        #region ---抽象---

        public override string Label => "场景模型";
        ...
        [Sirenix.OdinInspector.FilePath(ParentFolder = "Assets/Arts/Plots", Extensions = "prefab")]
        ...
        {
            var pathName = $"{PlotDefineUtil.PLOT_MODEL_PATH_FOLDER}/{this.modelRes}";
#if UNITY_EDITOR
