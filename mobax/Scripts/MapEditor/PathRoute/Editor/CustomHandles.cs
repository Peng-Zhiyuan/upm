...
public class CustomHandles
{
    ...
    public static Vector3 WorldStartPos
    {
        get {
            return s_DragHandleWorldStart;
        }
    }
        ...
        switch (e.GetTypeForControl(id)) {
            case EventType.MouseDown:
                if (HandleUtility.nearestControl == id && (e.button == 0 || e.button == 1)) {
                    ...
                    s_DragHandleMouseCurrent = s_DragHandleMouseStart = e.mousePosition;
            ...
            case EventType.MouseUp:
                if (GUIUtility.hotControl == id && (e.button == 0 || e.button == 1)) {
                    ...
                    if (e.mousePosition == s_DragHandleMouseStart) {
            ...
            case EventType.MouseDrag:
                if (GUIUtility.hotControl == id) {
                    s_DragHandleMouseCurrent += new Vector2(e.delta.x, -e.delta.y);
            ...
            case EventType.Repaint:
                ...
                if ((id == GUIUtility.hotControl || id == HandleUtility.nearestControl)&& s_DragHandleHasMoved )
