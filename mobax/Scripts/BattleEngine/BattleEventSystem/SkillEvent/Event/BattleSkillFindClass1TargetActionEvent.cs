...
// {
//     public class BattleSkillFindClass1TargetActionEvent : IBattleEvent
//     {
//         public string GetEventName()
//         {
//             return "SkillFindClass1TargetActionEvent";
//         }
//
...
// //             if (actorEntity.ReadySkill != null && actorEntity.ReadySkill.SkillConfigObject.AffectTargetType == SKILL_AFFECT_TARGET_TYPE.Enemy)
// //             {
...
// //                             {
// //                                 if (data1.Current.Value[i] != null && data1.Current.Value[i].CurrentHealth.Value > 0)
// //                                 {
