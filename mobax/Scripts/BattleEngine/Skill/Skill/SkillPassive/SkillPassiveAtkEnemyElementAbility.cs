...
{
    public class SkillPassiveAtkEnemyElementAbility : SkillPassiveAbility
    {
        public override BUFF_TRIGGER_TYPE GetPassiveType()
        {
            return BUFF_TRIGGER_TYPE.PASSIVE_TARGET_ELEMENT;
        }
        ...
        private void OnPostCauseDamage(ActionExecution combatAction)
        {
            ...
            if (targetHeroRow.Element == buffTrigger.trigRate1
                && isTriggerChance())
            {
                TriggerAddBuff();
            }
