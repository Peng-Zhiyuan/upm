...
namespace SG
{
    ...
    public class ResourceManager : MonoBehaviour
    {
        ...
        public void InitPoolWithGameObject(GameObject pb, int size, PoolInflationType type = PoolInflationType.DOUBLE)
        {
            if (pb == null)
            {
                Debug.LogError("[ResourceManager] Invalide prefab for pooling");
                return;
            }
            poolDict[pb.name] = new Pool(pb.name, pb, gameObject, size, type);
        }
