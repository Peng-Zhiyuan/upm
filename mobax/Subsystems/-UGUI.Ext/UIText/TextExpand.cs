...
namespace DCG.UI
{
    ...
    {
        [Header("是否使用渐变色")] public bool useGradientColor = false;
        [Header("左上颜色,右上颜色,左下颜色,右下颜色")] public Color32 gradientColor1 = Color.white;
        ...
        [Header("是否开启对齐")] public bool useAlign = false;
        [Header("字间距")] public float wordSpace = 0;
        [Header("行间距")] public float lineSpace = 0;

        [Header("是否显示下划线")] public bool useUnderline = false;
        ...
        [Header("横线对齐到行的上下中间")] public bool lineAlignToMiddle = false;
            ...
            float bottomY, Vector2 uv0)
        {
            ...
            // 左上
            var pos0 = new Vector3(this.GetCharCursorPos(startIndex, firstCharOff).x,
                bottomY + (this.lineHeightJustify ? this._lineHeightHalf : 0), 0);
            ...
            var pos2 = new Vector3(
                this.GetCharCursorPos(endIndex, firstCharOff).x +
                characters[endIndex].charWidth / this.text.pixelsPerUnit, pos1.y, 0);
