...
namespace ProtoBuf.Serializers
{
    ...
    public class MapDecoratorAOTRef<TDictionary, TKey, TValue> : MapDecorator<TDictionary, TKey, TValue> where TDictionary : class, IDictionary<TKey, TValue>
    {
        public MapDecoratorAOTRef() : base(null, null, null, null, 0, WireType.String, WireType.StartGroup, WireType.SignedVariant, false)
        {
            throw new Exception("[MapDecorator] This Creator should not be called");
        }
    }



    public class MapDecorator<TDictionary, TKey, TValue> : ProtoDecoratorBase where TDictionary : class, IDictionary<TKey, TValue>
    {
        ...
        public MapDecorator(TypeModel model, Type concreteType, IProtoSerializer keyTail, IProtoSerializer valueTail,
