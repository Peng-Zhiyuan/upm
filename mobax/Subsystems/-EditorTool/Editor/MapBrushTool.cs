...
public class MapBrushTool
{
   
    private const string MAP_PATH = "Assets/MapSprites";
	//[MenuItem ("Assets/CustomBrushTools/MapPrefabBrush")]
	static async void MapPrefabBrush () {
		...
		foreach (UnityEngine.Object activeObject in selection) {
			...
			string fullPath = GetFullPath(MAP_PATH + "/"+ dirName);
			...
			//var mu = go.GetOrAddComponent<MapUnit> ();
