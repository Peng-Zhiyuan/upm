Shader "NGEnv/Water"
{
	Properties{
		...
		[Header(Transparency)]
		[Space(5)]
		_DepthDistance("Transparency", Range(0.01, 10.0)) = 2.0
		...
		_FresnelStrength("Refl. Fresnel Strength", Range(0.0, 1.0)) = 1
		_FresnelPower("Refl. Fresnel Power", Range(0.0, 30.0)) = 1
		...
		_AlphaFresnelStrength("ColorGradient Fresnel Strength", Range(0.0, 1.0)) = 1
		_AlphaFresnelPower("ColorGradient Fresnel Power", Range(0.0, 30.0)) = 1
		...
		SubShader{
			...
			//#pragma multi_compile _ _LOW_QUALITY_WATER
			...
			#include "Include/NGEnv_WATER_COMMON.hlsl"
