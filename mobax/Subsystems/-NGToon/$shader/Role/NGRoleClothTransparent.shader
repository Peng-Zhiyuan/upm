Shader "NGRole/Cloth/Transparent"
{
	Properties
	{
		...
		_RimThreshold("Rim Threshold", Range(0,1)) = 0.1
			...
			*/
			...
			//_EmissionAnim("Emission Anim", Float) = 0
			...
			_StockingFresnelSmooth("Fresnel Smooth",Range(0, 1)) = 1
			_StockingFresnelThreshould("Fresnel Threshould",Range(0, 1)) = 0.5
			...
			_StockingSpecularSmooth("Specular Smooth",Range(0, 1)) = 1
			_StockingSpecularThreshould("Specular Threshould",Range(0, 1)) = 0.5
			...
			*/
			[Toggle(_USE_FLOW_MAP)] _UseFlowMap("Use Flow Map", Float) = 0
			_FlowMask("Flow Mask", 2D) = "white" {}
			_FlowMap("Flow Map", 2D) = "white" {}
			[HideInInspector]_FlowSpeed("Flow Speed", Vector) = (0, 0, 0, 0)
			...
			[HideInInspectUV]_UseViewPortClip("Use ViewPort Clip",Float) = 0
			...
			_DissolveRange("Dissolve Range", Range(0,1)) = 0.5
			//_DissolveDir("Dissolve Dir", Range(0, 1)) = 1
	}
	SubShader{
		...
		Pass {
			...
			#pragma shader_feature_local _ _USE_METALLIC
			#pragma shader_feature_local _ _USE_CARTOON_METAL
			...
			#pragma multi_compile_local _ _USE_STOCK
			//#pragma multi_compile_local _ _USE_FLOW_MAP
		...
		Pass{
			Name "ClothTransparent"
			Tags{"LightMode" = "ClothTransparent"}
			//Blend SrcAlpha OneMinusSrcAlpha
			Blend[_SrcBlendNG][_DstBlendNG]
			Cull Back
			ZWrite Off
...
/*
		...
		Pass{
			Name "ClothTransparentLow"
			Tags{"LightMode" = "ClothTransparentLow"}
			Blend SrcAlpha OneMinusSrcAlpha
			Cull Back
			ZWrite Off
			HLSLPROGRAM
		...
		*/
		...
		//	#pragma fragmentoption ARB_precision_hint_fastest       
		//	#pragma shader_feature_local _ _OUTLINE_UV2_AS_NORMALS
		//	//#pragma shader_feature_local _ _OUTLINE_USE_VERTEXCOLOR
