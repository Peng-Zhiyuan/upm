...
public static class AndroidBuild
{
    ...
    public static void Build(bool useUnityDevelopment = false, bool connectWithProfiler = false)
    {
        ...
        //var isUnityDevelopment =  EditorUserBuildSettings.development;
        BuildOptions optionList = BuildOptions.None;
        if (useUnityDevelopment)
        {
            optionList |= BuildOptions.Development;
        }
        if (connectWithProfiler)
        {
            optionList |= BuildOptions.Development;
            //optionList |= BuildOptions.ConnectWithProfiler; 2020.3LTF的bug,选上无法链接profiler
            optionList |= BuildOptions.EnableDeepProfilingSupport;
            //optionList |= BuildOptions.AllowDebugging;
        }
