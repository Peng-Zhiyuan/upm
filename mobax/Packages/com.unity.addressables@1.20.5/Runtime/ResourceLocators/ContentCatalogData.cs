...
namespace UnityEngine.AddressableAssets.ResourceLocators
{
    ...
    public class ContentCatalogData
    {
        ...
        public class CompactLocation : IResourceLocation
        {
            ...
            // 已修改
            // 控制是否允许缓存类型
            public static bool canCacheType = true;
            ...
            public Type ResourceType
            {
                ...
                { 
                    ...
                    // 重新获取类型对象
                    var type = this.serializedType.Value;
                    var finalType = type == null ? typeof(object) : type;
                    if (canCacheType)
                    {
                        m_Type = finalType;
                    }
            ...
            public CompactLocation(ResourceLocationMap locator, string internalId, string providerId, object dependencyKey, object data, int depHash, string primaryKey, SerializedType serializedType)
            {
                m_Locator = locator;
        ...
        public ResourceLocationMap CreateLocator(string providerSuffix = null)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                locations[i] = new CompactLocation(locator, Addressables.ResolveInternalId(ExpandInternalId(m_InternalIdPrefixes, m_InternalIds[internalId])),
                    m_ProviderIds[providerIndex], dependencyKeyIndex < 0 ? null : keys[dependencyKeyIndex], data, depHash, keys[primaryKey].ToString(), m_resourceTypes[resourceType]);
            }
