Shader "Universal Render Pipeline/Spine/SpriteToon1"
{
	Properties
	{ 
		...
		_AoOffset("Ao Offset", Range(0,1)) = 0.5
		_SpeOffset("Spe Offset", Range(0,1)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "Include/Spine-Sprite-ForwardPass-URP1225.hlsl"
			ENDHLSL
		}
	...
	CustomEditor "SpineSpriteShaderGUI1223"
}
