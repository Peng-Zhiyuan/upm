...
float DistanceAttenuationBak2(float distanceSqr, half2 distanceAttenuation)
{
 


    float lightAtten = rcp(pow(distanceSqr,.15f));
...
float DistanceAttenuationURP(float distanceSqr, half2 distanceAttenuation)
{
