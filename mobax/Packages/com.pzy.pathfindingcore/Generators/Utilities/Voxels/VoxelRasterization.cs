...
namespace PathfindingCore.Voxels {
	...
	public partial class Voxelize {
		...
		PathfindingCore.Util.GraphTransform transform;

		/// <summary>Transform from voxel space to graph space</summary>
		public PathfindingCore.Util.GraphTransform transformVoxel2Graph { get; private set; }
		...
		public void VoxelizeInput (PathfindingCore.Util.GraphTransform graphTransform, Bounds graphSpaceBounds) {
			...
			transformVoxel2Graph = new PathfindingCore.Util.GraphTransform(voxelMatrix);
		...
		public void ErodeWalkableArea (int radius) {
			...
			PathfindingCore.Util.Memory.MemSet<ushort>(src, 0xffff, sizeof(ushort));
