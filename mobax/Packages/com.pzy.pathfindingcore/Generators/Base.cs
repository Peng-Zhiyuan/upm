...
namespace PathfindingCore {
	...
	public abstract class NavGraph : IGraphInternals {
		...
		/// </code>
		///
		/// See: <see cref="PathfindingCore.AstarData.GetNodes"/>
		/// </summary>
	...
	public class GraphCollision {
		...
		/// See: <see cref="PathfindingCore.ColliderType"/>
		/// </summary>
	...
	/// See: <see cref="PathfindingCore.GraphCollision"/>
	/// </summary>
