...
namespace PathfindingCore {
	...
	/// See: <see cref="PathfindingCore.IRaycastableGraph"/>
	///
	...
	///
	/// For navmesh/recast graphs the <see cref="PathfindingCore.FunnelModifier"/> is a much better and faster alternative.
	///
...
#endif
				if (n1 == null) n1 = this.Astar.GetNearest(v1, nnConstraint).node;
				if (n2 == null) n2 = this.Astar.GetNearest(v2, nnConstraint).node;
