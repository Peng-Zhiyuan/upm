...
namespace PathfindingCore {
	...
	public class RelevantGraphSurface : VersionedMonoBehaviour {
		...
		public static void FindAllGraphSurfaces () {
			var srf = CoreObject.FindObjectsOfType<RelevantGraphSurface>();
		...
		public override void DrawGizmos () {
			...
			Draw.Line(Transform.position - (FixedVector3)Vector3.up*maxRange, Transform.position + (FixedVector3)Vector3.up*maxRange, color);
		}
	}
}
