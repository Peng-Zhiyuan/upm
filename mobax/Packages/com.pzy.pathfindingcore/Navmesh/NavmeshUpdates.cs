...
namespace PathfindingCore {
	...
	/// See: <see cref="AstarPathCore.navmeshUpdates"/>
	/// See: <see cref="PathfindingCore.NavmeshBase.enableNavmeshCutting"/>
	/// </summary>
	[System.Serializable]
	public class NavmeshUpdates {
		...
		internal NavmeshUpdates(AstarPathCore astar) {
			this.astar = astar;
		}
		...
		public void ForceUpdate () {
			...
			for (int graphIndex = 0; graphIndex < graphs.Length; graphIndex++) {
				...
				handler.StartBatchLoad(this.astar);
				...
				handler.EndBatchLoad(this.astar);
			}
		}
	}
}
