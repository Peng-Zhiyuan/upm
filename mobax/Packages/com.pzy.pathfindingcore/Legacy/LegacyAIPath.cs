	...
	public class LegacyAIPath : AIPath {
		...
		public override void OnCoreAwake()
		{
			...
			if (rvoController != null) {
				...
				else Debug.LogError("The LegacyAIPath component only works with the legacy RVOController, not the latest one. Please upgrade this component", this.coreObject.debbugerGameObject as UnityEngine.Object);
			}
		}
		...
		protected override void OnUpdate (float dt) {
			...
			if (controller != null) {
				...
				throw new System.Exception("[LagacyAIPath] not implement yet");
