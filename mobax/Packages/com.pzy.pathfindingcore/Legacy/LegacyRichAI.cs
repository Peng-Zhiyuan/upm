	...
	public class LegacyRichAI : RichAI {
		...
		public override void OnCoreAwake()
		{
			...
			if (rvoController != null) {
				...
				else Debug.LogError("The LegacyRichAI component only works with the legacy RVOController, not the latest one. Please upgrade this component", this.coreObject.debbugerGameObject as UnityEngine.Object);
			}
		}
