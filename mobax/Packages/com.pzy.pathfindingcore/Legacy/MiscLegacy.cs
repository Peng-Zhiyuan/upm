...
namespace PathfindingCore {
	...
	public partial class AIPath {
		...
		public FixedVector3 targetDirection {
			get {
				return ((FixedVector3)steeringTarget - tr.position).normalized;
			}
		}
	...
	public partial class RichAI {
		...
		public Animation anim {
			get {
				var setter = GetComponent<PathfindingCore.Examples.AnimationLinkTraverser>();
				return setter != null ? setter.anim : null;
			}
			set {
				animCompatibility = null;
				var setter = GetComponent<PathfindingCore.Examples.AnimationLinkTraverser>();
				if (setter == null) setter = coreObject.AddComponent<PathfindingCore.Examples.AnimationLinkTraverser>();
				setter.anim = value;
			}
		}
	}
