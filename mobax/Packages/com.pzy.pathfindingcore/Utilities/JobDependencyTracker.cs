//#define DEBUG_JOBS
namespace PathfindingCore.Jobs {
	...
	struct SimpleNativeList<T> where T : struct {
		public int count;
	...
	/// </code>
	///
	/// See: <see cref="PathfindingCore.Util.IJobExtensions"/>
	/// </summary>
	...
	public static class IJobExtensions {
		...
		///
		/// See: <see cref="PathfindingCore.Util.JobDependencyTracker"/>
		/// </summary>
