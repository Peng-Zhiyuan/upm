...
namespace PathfindingCore.Util {
	...
	public class BatchedEvents : VersionedMonoBehaviour {
		...
		void DelayedDestroy () {
			...
			CoreObject.DestroyImmediate(coreObject);
		}
#endif
		...
		static void CreateInstance () {
			...
			//var go = new CoreObject("Batch Helper");
			var go = CoreEngine.lastestInstance.Create("Batch Helper");
