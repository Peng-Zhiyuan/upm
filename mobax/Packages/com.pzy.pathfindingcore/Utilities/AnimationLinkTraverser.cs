...
namespace PathfindingCore.Examples {
	...
	/// See: <see cref="PathfindingCore.RichAI.onTraverseOffMeshLink"/>
	/// See: <see cref="PathfindingCore.AnimationLink"/>
	/// </summary>
	...
	public class AnimationLinkTraverser : VersionedMonoBehaviour {
		...
		protected virtual IEnumerator TraverseOffMeshLink (RichSpecial rs) {
			...
			throw new System.Exception("[CoreEngine] transform hierarchy not support");
			//// Reposition
