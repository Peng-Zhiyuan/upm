...
namespace PathfindingCore {
	...
	public interface IAstarAI {
		...
		///
		/// Note: The <see cref="PathfindingCore.AILerp"/> script doesn't really have any use of knowing the radius or the height of the character, so this property will always return 0 in that script.
		/// </summary>
		...
		///
		/// Note: The <see cref="PathfindingCore.AILerp"/> movement script doesn't use local avoidance or gravity so this property will always be identical to <see cref="velocity"/> on that component.
		/// </summary>
		...
		/// </code>
		///
		/// Note: The <see cref="PathfindingCore.AILerp"/> movement script doesn't use local avoidance so this property will always be identical to <see cref="velocity"/> on that component.
		///
		...
		/// </code>
		/// </summary>
		FixedVector3 destination { get; set; }
		...
		///
		/// See: Take a look at the <see cref="PathfindingCore.AIDestinationSetter"/> source code for an example of how it can be used.
		/// </summary>
