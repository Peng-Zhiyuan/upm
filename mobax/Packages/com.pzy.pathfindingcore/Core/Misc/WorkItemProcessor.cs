...
namespace PathfindingCore {
	...
	/// See: <see cref="AstarPathCore.UpdateGraphs"/>
	/// See: <see cref="AstarPathCore.AddWorkItem"/>
	/// </summary>
	...
	public interface IWorkItemContext {
		...
		/// If you are using the <see cref="PathfindingCore.GraphNode.Area"/> property or the <see cref="PathfindingCore.PathUtilities.IsPathPossible"/> method in your work items, then you might want to call this method before you use them
		...
		/// This will cause a <see cref="PathfindingCore.GraphModifier.PostUpdate"/> event to be issued after all graph updates have finished.
	...
	class WorkItemProcessor : IWorkItemContext {
		...
		public WorkItemProcessor (AstarPathCore astar) {
			this.astar = astar;
		}
