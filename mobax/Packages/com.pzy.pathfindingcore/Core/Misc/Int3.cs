...
namespace PathfindingCore {
	...
	public struct Int3 : System.IEquatable<Int3> {
		...
		public Int3(FixedVector3 position)
		{
			x = (int)System.Math.Round((double)(position.x * FloatPrecision));
			y = (int)System.Math.Round((double)(position.y * FloatPrecision));
			z = (int)System.Math.Round((double)(position.z * FloatPrecision));
		}
		...
		public static explicit operator Int3(FixedVector3 ob)
		{
			return new Int3(
				(int)System.Math.Round((double)(ob.x * FloatPrecision)),
				(int)System.Math.Round((double)(ob.y * FloatPrecision)),
				(int)System.Math.Round((double)(ob.z * FloatPrecision))
				);
		}
		...
		public static explicit operator FixedVector3(Int3 ob)
		{
			return new FixedVector3(ob.x * PrecisionFactor, ob.y * PrecisionFactor, ob.z * PrecisionFactor);
		}
