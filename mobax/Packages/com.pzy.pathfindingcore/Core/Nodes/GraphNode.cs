	...
	public abstract class GraphNode {
		...
		public NavGraph Graph {
			get {
				...
				return Destroyed ? null : AstarData.GetGraph(this.astar, this);
			}
		}
		...
		/// Penalty cost for walking on this node.
		/// This can be used to make it harder/slower to walk over certain nodes.
		/// A cost of 1000 (<see cref="PathfindingCore.Int3.Precision"/>) corresponds to the cost of moving 1 world unit.
		///
		/// See: graph-updates (view in online documentation for working links)
		/// </summary>
		public uint Penalty {
		...
		public uint Area {
			get {
				return this.Graph.active.hierarchicalGraph.GetConnectedComponent(HierarchicalNodeIndex);
			}
		}

		/// <summary>
		/// Graph which contains this node.
		/// See: <see cref="PathfindingCore.AstarData.graphs"/>
		/// See: <see cref="Graph"/>
		/// </summary>
		...
		/// such as the <see cref="Walkable"/> property or the <see cref="AddConnection"/> method. For example if your manually change the <see cref="PathfindingCore.MeshNode.connections"/> array you need to call this method.
		/// </summary>
