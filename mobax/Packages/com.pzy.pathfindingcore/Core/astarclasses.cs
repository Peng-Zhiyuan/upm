...
namespace PathfindingCore {
	...
	public class AstarColor {
		...
		/// </summary>
		public void PushToStatic (AstarPathCore astar) {
	...
	/// This is the return value by the <see cref="PathfindingCore.IRaycastableGraph.Linecast"/> methods.
	...
	/// <summary>Nearest node constraint. Constrains which nodes will be returned by the <see cref="AstarPathCore.GetNearest"/> function</summary>
	public class NNConstraint {
		...
		/// </code>
		///
		/// Note: This does only affect which nodes are returned from a <see cref="AstarPathCore.GetNearest"/> call, if a valid graph is connected to an invalid graph using a node link then it might be searched anyway.
		///
		/// See: <see cref="AstarPathCore.GetNearest"/>
		...
		/// [Open online documentation to see images]
		///
		/// The navmesh/recast graphs also contain a global option for this: <see cref="PathfindingCore.NavmeshBase.nearestSearchOnlyXZ"/>.
		/// </summary>
		...
		/// Uses distance from <see cref="AstarPathCore.maxNearestNodeDistance"/>.
	...
	/// See: <see cref="AstarPathCore.ScanAsync"/>
	/// </summary>
	...
	public class GraphUpdateObject {
		...
		/// If you need this info immediately, use <see cref="AstarPathCore.FlushGraphUpdates"/>.
		/// </summary>
		...
		/// See: <see cref="PathfindingCore.PathUtilities.UpdateGraphsNoBlock"/>
		/// </summary>
	...
	public struct GraphMask {
		...
		/// </code>
		/// </summary>
		public static GraphMask FromGraphName (AstarPathCore astar, string graphName) {
			var graph = astar.data.FindGraph(g => g.name == graphName);
	...
	public delegate void OnScanDelegate(AstarPathCore script);
	...
	public enum GraphDebugMode {
		...
		/// See: graph-updates (view in online documentation for working links)
		/// See: <see cref="PathfindingCore.GraphNode.Penalty"/>
		/// </summary>
		Penalty,
		/// <summary>
		...
		///
		/// See: <see cref="PathfindingCore.HierarchicalGraph"/>
		...
		/// See: <see cref="PathfindingCore.GraphNode.Tag"/>
		/// </summary>
		Tags,
		/// <summary>
	...
	public enum PathCompleteState {
		...
		/// See: <see cref="PathfindingCore.Path.IsDone()"/>
		/// </summary>
		NotCalculated = 0,
		/// <summary>
		/// The path calculation is done, but it failed.
		/// See: <see cref="PathfindingCore.Path.error"/>
		/// </summary>
		Error = 1,
		...
		/// See: <see cref="PathfindingCore.ABPath.calculatePartial"/>
		/// </summary>
		Partial = 3,
	}
