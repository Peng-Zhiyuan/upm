...
namespace PathfindingCore {
	...
	public class GraphUpdateSceneEditor : EditorBase {
		...
		public void OnSceneGUI () {
			...
			if (Selection.activeGameObject != script.coreObject.debbugerGameObject as GameObject || script.legacyMode) return;
			...
			List<Vector3> points = PathfindingCore.Util.ListPool<Vector3>.Claim();
			...
			script.RecalcConvex();
			PathfindingCore.Util.ListPool<Vector3>.Release(ref points);
