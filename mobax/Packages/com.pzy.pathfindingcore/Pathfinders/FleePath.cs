...
namespace PathfindingCore {
	...
	public class FleePath : RandomPath {
		...
		/// </summary>
		public static FleePath Construct (AstarPathCore astar, Vector3 start, Vector3 avoid, int searchLength, OnPathDelegate callback = null) {
			var p = PathPool.GetPath<FleePath>(astar);
