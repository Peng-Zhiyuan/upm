...
namespace PathfindingCore {
	...
	public class FloodPathTracer : ABPath {
		...
		public static FloodPathTracer Construct (AstarPathCore astar, Vector3 start, FloodPath flood, OnPathDelegate callback = null) {
			var p = PathPool.GetPath<FloodPathTracer>(astar);
