...
namespace PathfindingCore {
	...
	public class ConstantPath : Path {
		...
		public static ConstantPath Construct (AstarPathCore astar, Vector3 start, int maxGScore, OnPathDelegate callback = null) {
			var p = PathPool.GetPath<ConstantPath>(astar);
