...
//     public static bool IsEscape (string path) {
//         if (path.Contains ("/@")) {
//             return true;
//         }
//         return false;
...
//     public static MaxSize GetTextureMaxSizeBySettings (string path) {
//         var settings = Settings;
...
//         var defaultFormat = settings.maxSize;
//         return defaultFormat;
//     }
...
//         var maxSize = GetTextureMaxSizeBySettings (path);

//         //Debug.Log("path: " + path + " formate: " + targetFormate);
...
//             // 当为 Auto 时，表示不干涉格式
//             if (targetFormate != TextureImporterFormat.Automatic) {
...
//             // max size
//             if (maxSize != MaxSize.NotSet) {
//                 var nSize = (int) maxSize;
//                 if (platformSettings.maxTextureSize != nSize) {
//                     platformSettings.maxTextureSize = nSize;
//                 }
