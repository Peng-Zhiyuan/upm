...
namespace BehaviorDesigner.Runtime
{
    public class JSONDeserialization : UnityEngine.Object
    {
        ...
        private static void DeserializeVariables(IVariableSource variableSource, Dictionary<string, object> dict, List<ICoreEngineSystemObject> unityObjects)
        {
            object dictObj;
        ...
        public static Task DeserializeTask(BehaviorSource behaviorSource, Dictionary<string, object> dict, ref Dictionary<int, Task> IDtoTask, List<ICoreEngineSystemObject> unityObjects)
        {
            Task task = null;
            try {
        ...
        private static SharedVariable DeserializeSharedVariable(Dictionary<string, object> dict, IVariableSource variableSource, bool fromSource, List<ICoreEngineSystemObject> unityObjects)
        {
            if (dict == null) {
                return null;
            }
            ...
            if (sharedVariable == null || !(typesEqual = sharedVariable.GetType().Equals(variableType))) {
                ...
                if (!sharedVariable.IsGlobal && dict.TryGetValue("PropertyMapping", out dictValue)) {
                    ...
                    if (dict.TryGetValue("PropertyMappingOwner", out dictValue)) {
                        sharedVariable.PropertyMappingOwner = IndexToUnityObject(Convert.ToInt32(dictValue, CultureInfo.InvariantCulture), unityObjects) as CoreObject;
                    }
        ...
        private static void DeserializeObject(Task task, object obj, Dictionary<string, object> dict, IVariableSource variableSource, List<ICoreEngineSystemObject> unityObjects)
        {
        ...
        private static object ValueToObject(Task task, Type type, object obj, IVariableSource variableSource, List<ICoreEngineSystemObject> unityObjects)
        {
        ...
        private static object IndexToUnityObject(int index, List<ICoreEngineSystemObject> unityObjects)
        {
