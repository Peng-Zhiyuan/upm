...
namespace BehaviorDesigner.Runtime
{
    ...
    public class BehaviorSource : IVariableSource
    {
        ...
        // 添加
        public Behavior OwnerAsComponent
        {
            get
            {
                // 尝试把 Owner 转换为行为树组件类型
                return Owner as Behavior;
            }
        }

        public ExternalBehavior OwnerAsBehaviorData
        {
            get
            {
                // 尝试把 Owner 转换为行为树组件类型
                return Owner as ExternalBehavior;
            }
        }
