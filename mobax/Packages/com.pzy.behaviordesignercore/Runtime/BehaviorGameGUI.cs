...
namespace BehaviorDesigner.Runtime
{
    ...
    public class BehaviorGameGUI : CoreComponent
    {
        ...
        public override void OnGUI()
        {
            ...
            {
                behaviorManager = this.coreEngine.FindStuff<BehaviorManager>();
            }
            ...
            for (int i = 0; i < behaviorTrees.Count; ++i) {
                ...
                var screenPos = Camera.main.WorldToScreenPoint(ownerTransform.position.ToVector3());
