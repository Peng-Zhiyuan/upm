...
namespace BehaviorDesigner.Runtime
{
    ...
    public class VariableSynchronizer : MonoBehaviour
    {
        ...
        {
            public SynchronizedVariable(SynchronizationType synchronizationType, bool setVariable, Behavior behavior, string variableName, bool global, CoreComponent targetComponent, string targetName, bool targetGlobal)
            {
            ...
            public CoreComponent targetComponent;
