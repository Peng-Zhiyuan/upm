...
extern "C"
{
 void LOG_CRUCIAL(){}
 void LOG_IMPORTANT(){}
 void HuatuoApi_SetInterpreterThreadFrameStackSize(){}
 void LOG_BASIC(){}
 void HuatuoApi_LoadMetadataForAOTAssembly(){}
 void HuatuoApi_GetInterpreterThreadFrameStackSize(){}
 void HuatuoApi_GetInterpreterThreadObjectStackSize(){}
 void HuatuoApi_SetInterpreterThreadObjectStackSize(){}
...
Class swiftClassFromString(NSString* className)
{
    ...
    NSString *appName = @"UnityFramework";
    NSString *classStringName = [NSString stringWithFormat:@"_TtC%lu%@%lu%@", (unsigned long)appName.length, appName, (unsigned long)className.length, className];
    id ret = NSClassFromString(classStringName);
    
    if(ret == nil)
    {
        NSString *appName = [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleName"];
        NSString *classStringName = [NSString stringWithFormat:@"_TtC%lu%@%lu%@", (unsigned long)appName.length, appName, (unsigned long)className.length, className];
        ret = NSClassFromString(classStringName);
    }
    return ret;
}
