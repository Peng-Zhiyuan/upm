...
namespace UnityEditor
{
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            metallicMapProp = FindProperty("_MetallicGlossMap", properties, false);
        ...
        {
            var emissive = true;
            var hadEmissionTexture = metallicMapProp.textureValue != null; // emissionMapProp.textureValue != null;

            if (!keyword)
            {
                materialEditor.ColorProperty(emissionColorProp, "Emission Color");
              /*  materialEditor.TexturePropertyWithHDRColor(Styles.emissionMap, metallicMapProp, emissionColorProp,
                    false);*/
            }
            else
            {
                ...
                emissive = materialEditor.EmissionEnabledProperty();
                 ...
                 EditorGUI.BeginDisabledGroup(!emissive);
                 {
                    ...
                    /* materialEditor.TexturePropertyWithHDRColor(Styles.emissionMap, metallicMapProp,
                         emissionColorProp,
                         false);*/
                 }
            ...
            if (metallicMapProp.textureValue != null && !hadEmissionTexture && brightness <= 0f)
