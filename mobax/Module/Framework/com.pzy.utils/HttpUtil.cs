...
public static class HttpUtil
{
    ...
    public static Task<string> RequestTextAsync(string url, HttpMethod method, Dictionary<string, string> postFormParam = null, string contentType = "application/x-www-form-urlencoded")
    { 
