...
public partial class SwitchViewV2 : MonoBehaviour
{
    PToggleGroup _group;
    ...
    //bool firstSelectioChnaged = true;
    //void RefreshSelectionBackground()
    //{
    //    var ptoggle = this.Group.Selected;
    //    if(ptoggle == null)
    //    {
    //        this.Image_selectionBg.gameObject.SetActive(false);
    //        firstSelectioChnaged = true;
    //        return;
    //    }
    //    LayoutRebuilder.ForceRebuildLayoutImmediate(this.rectTransform());
    //    var toggleView = ptoggle.GetComponent<GameToggleView>();
