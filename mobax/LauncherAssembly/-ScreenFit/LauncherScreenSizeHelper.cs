...
public class LauncerScreenSizeHelper
{
   public static LauncerScreenSizeHelper Instance = new LauncerScreenSizeHelper();
   private const int design_height = 1920;
   ...
   public int UIHeight
   {
    ...
    public Vector3 ScreenToUIPos(Vector3 screen_pos)
    {
        ...
        return  pos * this.FitInScale;
    }

     public Vector3 UIToScreenPos(Vector3 ui_pos)
    {
        Vector3 pos = ui_pos / this.FitInScale;
